...
## Project Structure
    ...
    ├── testapiautosetting_125078  # Django project configurations
...
1. Clone this repo and `cd testapiautosetting_125078`
...
2. Clone this repo and `cd testapiautosetting_125078`
